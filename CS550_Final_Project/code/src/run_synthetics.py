...
def run_experiemtns(lpd_lst):
    ...
    loss_frame = pnd.read_csv("/auto/k2/aykut3/spectral/CS550_USTRY_Test2.csv")
    time_frame = pnd.read_csv("/auto/k2/aykut3/spectral/CS550_USTRY_Test2_time.csv")
    for exp_no, lpd in enumerate(lpd_lst):
        ...
        param_str = time_str + '_' + lpd['cell_type'] + '_size_' + str(lpd['num_units']) + \
            ...
            '_pt_' + str(pgraph.total_parameters)+ '_nproj_'+str(lpd['num_proj'])
...
#                        buf.close()
            ...
            # epoch done. Save.
            print('Saving a copy.')
            loss_frame.loc[0,lpd['exp_name']]=np_loss
            time_frame.loc[0,lpd['exp_name']] = total_time
            loss_frame.to_csv("/auto/k2/aykut3/spectral/CS550_USTRY_Test2.csv",index=False)
            time_frame.to_csv("/auto/k2/aykut3/spectral/CS550_USTRY_Test2_time.csv",index=False)
